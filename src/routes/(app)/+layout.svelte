<script lang="ts">
	...
	const navItems = [
		{ label: "Resumen", icon: HomeIcon, href: "/", active: true },
		...
		<Sidebar.Root>
			<Sidebar.Header>
				<div class="flex items-center gap-2 px-2 py-1.5">
					...
					<div>
						<p class="text-sm font-semibold leading-none">Kotoba</p>
			...
			<Sidebar.Footer>
				<div class="flex items-center gap-3 rounded-lg bg-sidebar-accent p-3">
					<div class="flex size-8 items-center justify-center rounded-full bg-orange-500/20 text-orange-400">
